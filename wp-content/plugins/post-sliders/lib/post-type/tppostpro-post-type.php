<?php
	...
	function tppostslider_pro_post_register() {
		...
		$labels = array(
			'name'                => _x( 'Post Slider', 'Post Type General Name', 'post-sliders' ),
			'singular_name'       => _x( 'Post Slider', 'Post Type Singular Name', 'post-sliders' ),
			'menu_name'           => __( 'Post Slider ', 'post-sliders' ),
